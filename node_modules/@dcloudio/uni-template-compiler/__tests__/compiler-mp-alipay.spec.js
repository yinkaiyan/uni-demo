...
describe('mp:compiler-mp-alipay', () => {
  ...
  it('generate ref', () => {
    assertCodegen(
      ...
      `<component1 ref="__r" data-ref="c1" onTriggerLink="__l">text</component1>`
    )
    assertCodegen(
      '<component1 :ref="c2">text<text>123213</text></component1>',
      `<component1 ref="__r" data-ref="{{c2}}" onTriggerLink="__l">text<text>123213</text></component1>`
    )
    assertCodegen(
      '<component1 v-for="item in items" ref="c3"></component1>',
      `<block a:for="{{items}}" a:for-item="item" a:for-index="__i0__"><component1 ref="__r" data-ref-in-for="c3" onTriggerLink="__l"></component1></block>`
    )
    assertCodegen(
      '<component1 v-for="item in items" :ref="c4"></component1>',
      `<block a:for="{{items}}" a:for-item="item" a:for-index="__i0__"><component1 ref="__r" data-ref-in-for="{{c4}}" onTriggerLink="__l"></component1></block>`
    )
  })
  it('generate default slot', () => {
    assertCodegen(
      '<component1>text</component1>',
      `<component1 onTriggerLink="__l">text</component1>`
    )
    assertCodegen(
      '<component1>text<text>123213</text></component1>',
      `<component1 onTriggerLink="__l">text<text>123213</text></component1>`
    )
    assertCodegen(
      '<component1>text<block slot="right"></block></component1>',
      `<component1 onTriggerLink="__l">text<view slot="right"></view></component1>`
    )
  })
  ...
  it('generate events with v-on directive', () => {
    assertCodegen(
      ...
      `<uni-list-item title="标题文字" note="描述信息" show-extra-icon="true" extra-icon="{{$root.a0}}" onTriggerLink="__l"></uni-list-item>`,
