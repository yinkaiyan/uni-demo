...
describe('mp:compiler-mp-weixin', () => {
  it('generate scoped slot', () => {
    assertCodegen(
      ...
      `<foo generic:scoped-slots-default="test-foo-default" vue-slots="{{['default']}}"></foo>`,
      function (res) {
  ...
  it('generate named scoped slot', () => {
    assertCodegen(
      ...
      `<foo generic:scoped-slots-foo="test-foo-foo" vue-slots="{{['foo']}}"></foo>`,
      function (res) {
  ...
  it('generate scoped slot', () => {
    assertCodegen(
      ...
      `<label class="_span"><block wx:if="{{$slots.default}}"><scoped-slots-default user="{{user}}"></scoped-slots-default></block><block wx:else>{{user.lastName}}</block></label>`,
      function (res) {
    ...
    assertCodegen(
      ...
      `<label class="_span"><block wx:if="{{$slots.header}}"><scoped-slots-header user="{{user}}"></scoped-slots-header></block><block wx:else>{{user.lastName}}</block></label>`,
      function (res) {
