...
describe('mp:compiler', () => {
  ...
  it('generate multiline v-model directive on custom component', () => {
    assertCodegen(
      ...
      `<my-component value="{{test}}" data-event-opts="{{[['^input',[['__set_model',['$0','test','$event'],['']]]]]}}" bind:input="__e"></my-component>`
    )
  })
  ...
  it('generate component', () => {
    assertCodegen(
      ...
      `<my-component name="mycomponent1" msg="{{msg}}" data-event-opts="{{[['^notify',[['onNotify']]]]}}" bind:notify="__e" vue-slots="{{['default']}}"><view class="_div">hi</view></my-component>`
  ...
  it('generate is attribute', () => {
    ...
    assertCodegen(
      ...
      '<view class="_div"><component1></component1></view>'
    )
  })
  ...
  it('generate component with v-for', () => {
    ...
    assertCodegen(
      ...
      `<view class="_div"><child></child><block wx:for="{{list}}" wx:for-item="item" wx:for-index="__i0__">{{item}}</block></view>`
    )
  })
  ...
  it('should compile single v-for component inside template', () => {
    assertCodegen(
      ...
      `<view class="_div"><block wx:if="{{ok}}"><block wx:for="{{1}}" wx:for-item="i" wx:for-index="__i0__" wx:key="*this"><foo></foo></block></block></view>`
    )
  })
})
