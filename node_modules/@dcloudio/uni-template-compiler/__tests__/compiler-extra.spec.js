...
我的第二行2{{title}}</text>`,
  ...
  it('generate default slot', () => {
    assertCodegen(
      ...
      `<component1 vue-slots="{{['default']}}">text</component1>`
    )
    assertCodegen(
      '<component1>text<text>123213</text></component1>',
      `<component1 vue-slots="{{['default']}}">text<text>123213</text></component1>`
    )
    assertCodegen(
      '<component1>text<block slot="right"></block></component1>',
      `<component1 vue-slots="{{['default','right']}}">text<view slot="right"></view></component1>`
    )
  })
  ...
  it('generate v-slot', () => {
    assertCodegen(
      ...
      `<component1 vue-slots="{{['default','f','c']}}"><view slot="f">f</view><view slot="c">c</view>默认</component1>`
    )

    assertCodegen(
      '<component1 v-slot>text</component1>',
      `<component1 vue-slots="{{['default']}}"><view slot="default">text</view></component1>`
    )

    assertCodegen(
      '<component1 v-slot:default>text<text>123213</text></component1>',
      `<component1 vue-slots="{{['default']}}"><view slot="default">text<text>123213</text></view></component1>`
    )
    assertCodegen(
      '<component1><template v-slot:left><text></text></template><template v-slot:right><text></text></template></component1>',
      `<component1 vue-slots="{{['left','right']}}"><view slot="left"><text></text></view><view slot="right"><text></text></view></component1>`
    )
    assertCodegen(
      `<my-component>
      ...
      `<my-component vue-slots="{{['default','header','footer']}}"><view slot="header"><view class="_h1">Here might be a page title</view></view><view slot="footer"><view class="_p">Here's some contact info</view></view><view class="_p">A paragraph for the main content.</view></my-component>`
    )
  })
  ...
  it('generate events with v-on directive on custom component', () => {
    assertCodegen(
      ...
      `<my-component data-event-opts="{{[['^click',[['handleClick']]]]}}" bind:click="__e"></my-component>`
    )
    assertCodegen(
      '<my-component @click-left="handleClick"/>',
      `<my-component data-event-opts="{{[['^clickLeft',[['handleClick']]]]}}" bind:clickLeft="__e"></my-component>`
    )
  })
  ...
  it('generate v-model directive on custom component', () => {
    assertCodegen(
      ...
      `<my-component value="{{test}}" data-event-opts="{{[['^input',[['__set_model',['$0','test','$event'],['']],['handle']]]]}}" bind:input="__e" vue-slots="{{['default']}}">1</my-component>`
    )
    assertCodegen(
      '<my-component v-model="test" @click="handle">2</my-component>',
      `<my-component value="{{test}}" data-event-opts="{{[['^click',[['handle']]],['^input',[['__set_model',['$0','test','$event'],['']]]]]}}" bind:click="__e" bind:input="__e" vue-slots="{{['default']}}">2</my-component>`
    )
  })
  ...
  it('generate object property on custom component', () => {
    assertCodegen(
      ...
      `<my-component value="{{test}}" data-event-opts="{{[['^input',[['__set_model',['$0','test','$event'],['']],['handle']]]]}}" bind:input="__e"></my-component>`
    )
  })
  ...
  it('generate v-bind directive with sync modifier', () => {
    assertCodegen(
      ...
      `<text-document title="{{aaa}}" data-event-opts="{{[['^updateTitle',[['__set_sync',['$0','aaa','$event'],['']]]]]}}" bind:updateTitle="__e"></text-document>`
    )
    assertCodegen(
      '<text-document :title.sync="doc.title"></text-document>',
      `<text-document title="{{doc.title}}" data-event-opts="{{[['^updateTitle',[['__set_sync',['$0','title','$event'],['doc']]]]]}}" bind:updateTitle="__e"></text-document>`
    )
    assertCodegen(
      '<text-document :title.sync="doc.a.title"></text-document>',
      `<text-document title="{{doc.a.title}}" data-event-opts="{{[['^updateTitle',[['__set_sync',['$0','title','$event'],['doc.a']]]]]}}" bind:updateTitle="__e"></text-document>`
    )
    assertCodegen(
      '<text-document v-for="item in items" :title.sync="item.title"></text-document>',
      `<block wx:for="{{items}}" wx:for-item="item" wx:for-index="__i0__"><text-document title="{{item.title}}" data-event-opts="{{[['^updateTitle',[['__set_sync',['$0','title','$event'],[[['items','',__i0__,'']]]]]]]}}" bind:updateTitle="__e"></text-document></block>`
    )
    assertCodegen(
      '<text-document v-for="item in items" :title.sync="item.meta.title"></text-document>',
      `<block wx:for="{{items}}" wx:for-item="item" wx:for-index="__i0__"><text-document title="{{item.meta.title}}" data-event-opts="{{[['^updateTitle',[['__set_sync',['$0','title','$event'],[[['items','',__i0__,'meta']]]]]]]}}" bind:updateTitle="__e"></text-document></block>`
    )
  })
  ...
  it('generate v-model directive with generic modifiers', () => {
    assertCodegen(
      ...
      `<input data-event-opts="{{[['input',[['__set_model',['$0','test','$event',[]],['']]]]]}}" value="{{test}}" bindinput="__e"/>`
    )
    assertCodegen(
      '<input v-model.number="test">',
      `<input data-event-opts="{{[['input',[['__set_model',['$0','test','$event',['number']],['']]]],['blur',[['$forceUpdate']]]]}}" value="{{test}}" bindinput="__e" bindblur="__e"/>`
    )
    assertCodegen(
      '<input v-model.number.trim="test">',
      `<input data-event-opts="{{[['input',[['__set_model',['$0','test','$event',['number','trim']],['']]]],['blur',[['$forceUpdate']]]]}}" value="{{test}}" bindinput="__e" bindblur="__e"/>`
    )
    assertCodegen(
      '<input class="uni-input" @input="replaceInput" v-model="changeValue" placeholder="连续的两个1会变成2" />',
      `<input class="uni-input" placeholder="连续的两个1会变成2" data-event-opts="{{[['input',[['__set_model',['$0','changeValue','$event',[]],['']],['replaceInput',['$event']]]]]}}" value="{{changeValue}}" bindinput="__e"/>`
    )
  })
  ...
  it('generate v-for', () => {
    assertCodegen(
      ...
      `with(this){var l0=list.map(function(item,index){var m0=handle(item);return{$orig:__get_orig(item),m0:m0}});$mp.data=Object.assign({},{$root:{l0:l0}})}`
    )
    assertCodegen(
    ...
    assertCodegen(
      ...
      `with(this){var l1=list.map(function(item,index){var l0=list1.map(function(item1,index1){var m0=handle(item1);return{$orig:__get_orig(item1),m0:m0}});return{$orig:__get_orig(item),l0:l0}});$mp.data=Object.assign({},{$root:{l1:l1}})}`
    )
    assertCodegen(
      ...
      `with(this){var l1=sections.map(function(section,index){var f0=_f("prefix")(section.title);var l0=section.sub_titles.map(function(sub_titles,_index){var f1=_f("prefix")(sub_titles);return{$orig:__get_orig(sub_titles),f1:f1}});return{$orig:__get_orig(section),f0:f0,l0:l0}});$mp.data=Object.assign({},{$root:{l1:l1}})}`
    )
    ...
    assertCodegen(
      ...
      `with(this){var l0=list.map(function(item,index){var f0=_f("test1")(_f("test")(item.item.id));return{$orig:__get_orig(item),f0:f0}});$mp.data=Object.assign({},{$root:{l0:l0}})}`
    )
    assertCodegen(
      ...
      `with(this){var l0=list.map(function(item,i){var g0=item.split("").join(" ");return{$orig:__get_orig(item),g0:g0}});$mp.data=Object.assign({},{$root:{l0:l0}})}`
    )
  })
