...
function getProvides () {
  ...
  if (process.env.UNI_PLATFORM !== 'mp-weixin' && process.env.UNI_PLATFORM !== 'app-plus') { // 非微信小程序，自动注入 wx 对象
...
module.exports = {
  ...
  webpackConfig (webpackConfig) {
    ...
    let devtool = process.env.NODE_ENV === 'production' ? false : (process.env.UNI_PLATFORM === 'app-plus'
      ? 'eval'
      : 'sourcemap')
